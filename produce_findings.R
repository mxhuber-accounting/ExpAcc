...
# Fallback for dead APIs (Quandl requires API key since ~2023, RCurl has
# binary compatibility issues on modern R). Downloads the same data from
# alternative sources when cached files don't yet exist.
